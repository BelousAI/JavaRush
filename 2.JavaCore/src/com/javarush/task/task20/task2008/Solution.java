...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream ois3 = new ObjectInputStream(byteArrayInputStream);
        Singleton singleton2 = (Singleton) ois3.readObject();
        ois3.close();
        ...
        System.out.println("=========================================================");
        System.out.println("Object reference check : " + singleton.hashCode());
        System.out.println("Object reference check : " + singleton1.hashCode());
        System.out.println("Object reference check : " + singleton2.hashCode());
    }
