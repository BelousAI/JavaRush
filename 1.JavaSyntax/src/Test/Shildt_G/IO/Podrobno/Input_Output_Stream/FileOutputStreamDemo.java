...
//Используется традиционный способ закрытия файла
public class FileOutputStreamDemo {
    public static void main(String[] args) {
        ...
        try {
            f0 = new FileOutputStream("Test/file1.txt");
            f1 = new FileOutputStream("Test/file2.txt");
            f2 = new FileOutputStream("Test/file3.txt");
            ...
            System.out.println("Ошибка открытия файла вывода.");
        }
        catch (IOException e) {
